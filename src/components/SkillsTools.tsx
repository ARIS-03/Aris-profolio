...
const toolGroups = [
  {
    ...
    tools: [
      ...
      { name: "Google Search Console", icon: <img src="/assets/images_1.jpeg" className="w-8 h-8 object-contain" alt="Google Search Console" referrerPolicy="no-referrer" /> },
    ]
  },
  {
    ...
    tools: [
      ...
      { name: "CapCut", icon: <img src="/assets/images.jpeg" className="w-8 h-8 object-contain" alt="CapCut" referrerPolicy="no-referrer" /> },
  ...
  },
  {
    title: "Ads & Growth",
    tools: [
      { name: "Meta Ads", icon: <img src="/assets/images.png" className="w-8 h-8 object-contain" alt="Meta Ads" referrerPolicy="no-referrer" /> },
      ...
      { name: "Moengage", icon: <img src="/assets/images_2.jpeg" className="w-8 h-8 object-contain" alt="Moengage" referrerPolicy="no-referrer" /> },
    ]
  }
];
