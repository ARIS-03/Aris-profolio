      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8">
          ...
          <div className="lg:col-span-3 space-y-10">
            ...
            <div className="flex justify-start pl-4">
              <img src="/assets/Screenshot_2026-03-28_193426.png" alt="Milkmor Logo" className="h-14 object-contain mix-blend-multiply" />
            </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:-mt-24">
            ...
            >
              <div className="w-full max-w-[380px] bg-[#121212] rounded-[2.8rem] border-[10px] border-[#121212] shadow-2xl overflow-hidden relative text-white aspect-[9/19]">
                <img 
                  src="/assets/IMG_20260328_202119.jpg.jpeg" 
            ...
            >
              <div className="grid grid-cols-2 gap-1 rounded-xl overflow-hidden relative">
                <div className="aspect-square relative">
                  <img src="/assets/milkmorindia-20260328-0002.jpg.jpeg" alt="Swipe 1" className="w-full h-full object-cover" />
                  ...
                  <div className="absolute top-2 right-2">
                    <img src="/assets/Screenshot_2026-03-28_193426.png" alt="Logo" className="h-4 object-contain mix-blend-multiply brightness-0 invert" />
                  </div>
                ...
                <div className="aspect-square relative">
                  <img src="/assets/milkmorindia-20260328-0003.jpg.jpeg" alt="Swipe 2" className="w-full h-full object-cover" />
                  <div className="absolute top-2 left-2 flex gap-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-2.48 2.48-.73.03-1.13-.41-1.96-.41-.83 0-1.27.4-1.93.43-.69.03-1.63-1.25-2.48-2.48-1.74-2.52-3.07-7.11-1.26-10.25 1.07-1.87 3-3.04 5.08-3.07 1.58-.03 3.07 1.06 4.03 1.06.96 0 2.73-1.31 4.6-1.11 1.87.2 3.31 1.05 4.1 2.2-3.88 2.29-3.25 7.28.74 9.56-.75 1.88-1.72 3.75-3.03 5.59z"/></svg>
                  </div>
        ...
        <div className="flex justify-end mt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl w-full">
            ...
            >
              <img src="/assets/milkmorindia-20260328-0004.jpg.jpeg" alt="Post 1" className="w-full h-auto" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="rounded-2xl overflow-hidden shadow-2xl"
            >
              <img src="/assets/milkmorindia-20260328-0001.jpg.jpeg" alt="Post 2" className="w-full h-auto" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="rounded-2xl overflow-hidden shadow-2xl"
            >
              <img src="/assets/whatsapp_post_3.jpeg" alt="Post 3" className="w-full h-auto" />
            </motion.div>
          </div>
        </div>
      </div>
